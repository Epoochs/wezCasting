...
class WeatherActivity : AppCompatActivity(){
    ...
    fun getSavedWeather(lat: Double, lon: Double) {
        ...
        if(!isDestroyed) {
            ...
            sharedVM = ViewModelProvider(this).get(HomeSettingsSharedVM::class.java)

            sharedVM.lang.observe(this, Observer { lang ->
                println("Shared Language: " + lang)

                sharedVM.tempUnit.observe(this, Observer { tempUnit ->
                    println("Shared TempUnit: " + tempUnit)

                    sharedVM.windUnit.observe(this, Observer { windUnit ->
                        println("Shared WindUnit: " + windUnit)
                        sharedVM.unit.observe(this, Observer { unit ->
